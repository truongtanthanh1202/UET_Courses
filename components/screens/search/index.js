                  ...
                  <TouchableHighlight>
                    <Text
                      ...
                      style={[
                        styles2.item0,
                        {
                          backgroundColor: activeTab === 1 ? '#2e89ff' : '#fff',
                  ...
                  <TouchableHighlight>
                    <Text
                      ...
                      style={[
                        styles2.item0,
                        {
                          backgroundColor: activeTab === 2 ? '#2e89ff' : '#fff',
                  ...
                  <TouchableHighlight>
                    <Text
                      ...
                      style={[
                        styles2.item0,
                        {
                          backgroundColor: activeTab === 3 ? '#2e89ff' : '#fff',
  ...
  return (
    <View style={styles4.container}>
      <Image
        style={styles4.image}
        source={{
          uri: 'https://img.freepik.com/free-vector/night-ocean-landscape-full-moon-stars-shine_107791-7397.jpg',
        }}
      />
...
const products = [
  ...
  },
  {
    ...
    duration: '14 hours',
    imageUrl:
      'https://images.squarespace-cdn.com/content/v1/55da0cc3e4b07cfd7eba4fcb/1680887169965-2ZI92A2YJLOVKI3HAU87/image.jpg?format=1000w',
  },
  {
...
const ProductComponents = products.map(product => (
  <View style={styles3.container} key={product.title}>
    ...
    <View style={styles3.rightSide}>
      ...
      <View
        style={{display: 'flex', alignItems: 'center', flexDirection: 'row'}}>
        <Text style={{fontWeight: '600', color: '#2e89ff', fontSize: 18}}>
          {product.price}
        </Text>
        <Text
          style={{
