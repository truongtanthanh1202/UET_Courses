...
import {isValidPassword, isConfirmPassword} from '../../../utilies/Validations';

import styles from './style';

const ChangePassword = props => {
  const [textErrorOldPassword, setTextErrorOldPassword] = useState('');
